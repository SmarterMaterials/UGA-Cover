...
\usepackage{calligra}
\usepackage{ragged2e} % for justifier text
\usepackage{tikz}
...
\definecolor{BleuCyan}{RGB}{0,0,190}  %%% Définition d'une couleur personnelle
...
\definecolor{orange}{RGB}{232, 78, 15}
...
\definecolor{couleur_marie}{RGB}{0,102,204} 
...
\usepackage[labelfont=bf,font={normal, color=orange}]{caption}
\usepackage[labelfont=bf,font={normal, color=orange},labelsep={colon}]{caption}
